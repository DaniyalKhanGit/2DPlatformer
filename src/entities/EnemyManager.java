...
public class EnemyManager {
	...
	private BufferedImage[][] slimeArr, pinkstarArr, sharkArr;
	...
	private void drawSlimes(Graphics g, int xLvlOffset) {
		for (Slime s : currentLevel.getSlimes())
			if (s.isActive()) {
				...
				g.drawImage(slimeArr[0][s.getAniIndex()],
...
//				c.drawAttackBox(g, xLvlOffset);
	...
	private void loadEnemyImgs() {
		slimeArr = getImgArr(LoadSave.GetSpriteAtlas(LoadSave.SLIME_SPRITE), 11, 1, SLIME_WIDTH_DEFAULT,
				SLIME_HEIGHT_DEFAULT);
