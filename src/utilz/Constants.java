...
public class Constants {
	...
	public static class EnemyConstants {
		...
		public static final int SLIME_WIDTH_DEFAULT = 16;
		...
		public static final int SLIME_DRAWOFFSET_X = (int) (1 * Game.SCALE);
		public static final int SLIME_DRAWOFFSET_Y = (int) (22 * Game.SCALE);
